const networkManager = {
    fetchExperiments: function(projectID) {
        console.log("network manager is fetching experiments...");
        return projectID === "th" ? experiments_th : experiments_ck;
    },
    updateExperimentStatus: function(projectID, experimentID, state) {
        console.log("network manager is updating experiment status...");
        return;
    }
};
